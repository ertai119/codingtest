...
int main() {
	...
	inputDatas.push_back(Integer(3));
	inputDatas.push_back(Integer(5));
	inputDatas.push_back(Integer(7));

	std::vector<Integer> outputDatas;
